//! Specifications for QualityAction aggregate
//!
...
// Each predicate implements `Specification<QualityAction>` and can be combined
...
//
// pub struct ActiveQualityActionSpec;
// impl Specification<QualityAction> for ActiveQualityActionSpec {
//     fn is_satisfied_by(&self, e: &QualityAction) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
