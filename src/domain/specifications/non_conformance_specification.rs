//! Specifications for NonConformance aggregate
//!
...
// Each predicate implements `Specification<NonConformance>` and can be combined
...
//
// pub struct ActiveNonConformanceSpec;
// impl Specification<NonConformance> for ActiveNonConformanceSpec {
//     fn is_satisfied_by(&self, e: &NonConformance) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
