//! Specifications for QualityInspectionParameter aggregate
//!
...
// Each predicate implements `Specification<QualityInspectionParameter>` and can be combined
...
//
// pub struct ActiveQualityInspectionParameterSpec;
// impl Specification<QualityInspectionParameter> for ActiveQualityInspectionParameterSpec {
//     fn is_satisfied_by(&self, e: &QualityInspectionParameter) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
