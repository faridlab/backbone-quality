//! Specifications for QualityProcedure aggregate
//!
...
// Each predicate implements `Specification<QualityProcedure>` and can be combined
...
//
// pub struct ActiveQualityProcedureSpec;
// impl Specification<QualityProcedure> for ActiveQualityProcedureSpec {
//     fn is_satisfied_by(&self, e: &QualityProcedure) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
