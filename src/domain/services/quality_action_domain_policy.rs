//! Domain policy for QualityAction aggregate
//!
...
/// Domain policy for QualityAction — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<QualityAction>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type QualityActionDomainPolicy = PermitAllPolicy<QualityAction>;
